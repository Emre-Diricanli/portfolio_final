        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="flex flex-col md:flex-row gap-8 md:gap-16 items-center md:items-start">
            ...
            <div className="w-full md:w-2/3">
              ...
              {/* Tab content */}
              <div className="bg-neutral-900/50 backdrop-blur-sm rounded-2xl border border-white/10 p-6 md:p-8 min-h-[400px]">
      ...
      <div className="relative border-l-2 border-white/20 pl-6 pb-2">
        ...
        <div className="mb-8">
          <div className="flex flex-wrap justify-between items-center mb-1">
            ...
            <span className="bg-white/10 text-white/80 px-3 py-1 rounded-full text-sm">May 2024</span>
          </div>
          <p className="text-white/60 italic mb-3">University Name</p>
          <p className="text-white/80 leading-relaxed">
