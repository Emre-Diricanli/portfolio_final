  ...
  (
    ...
    return (
      ...
      >
        ...
        <AccordionPrimitive.Content className="relative h-full overflow-hidden text-lg data-[state=closed]:animate-accordion-up data-[state=open]:animate-accordion-down">
